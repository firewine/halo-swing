...
def _api_key_integration_status_route_count_top_level_fields(
    api_key_integration_status_summary: dict[str, Any],
) -> dict[str, Any]:
    return _route_family_count_top_level_fields(
        prefix="api_key_integration",
        source_summary=api_key_integration_status_summary,
    )


def _api_key_next_action_route_top_level_fields(
    api_key_next_action_summary: dict[str, Any],
) -> dict[str, Any]:
    return _route_family_summary_top_level_fields(
        prefix="api_key_next_action",
        source_summary=api_key_next_action_summary,
    )


def _api_key_provider_selection_route_count_top_level_fields(
    api_key_provider_selection_summary: dict[str, Any],
) -> dict[str, Any]:
    return _route_family_count_top_level_fields(
        prefix="api_key_provider",
        source_summary=api_key_provider_selection_summary,
    )


def _api_key_provider_smoke_route_count_top_level_fields(
    api_key_provider_smoke_route_summary: dict[str, Any],
) -> dict[str, Any]:
    return _route_family_count_top_level_fields(
