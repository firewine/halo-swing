...
def _api_key_integration_status_top_level_fields(
    *,
    ...
    one_shot_pipeline_smoke_unblock_source_path = None
    one_shot_pipeline_smoke_unblock_target_path = None
    ...
    one_shot_pipeline_smoke_unblock_followup_smoke_required_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    ...
    one_shot_pipeline_smoke_unblock_followup_smoke_blocked_provider_family_count = 0
    one_shot_pipeline_smoke_unblock_followup_smoke_all_provider_families_configured = (
        False
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_setup_status_by_family: dict[
        str, Any
    ] = {}
    ...
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_status = None
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_requires_api_keys = (
        False
    )
    ...
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_provider_family_count = (
        0
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_blocked_provider_family_count = (
        0
    )
    ...
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_all_selected_routes_live = (
        False
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_family_count = (
        0
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_family_count = (
        0
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_live_data_required_family_count = (
        0
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_data_mode_counts: dict[
        str, int
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_by_family: dict[
        str, Any
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_preferred_env_key_by_family: dict[
        str, Any
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_accepted_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_required_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys: list[
        str
    ] = []
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys: list[
        str
    ] = []
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_by_family: dict[
        str, bool
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_setup_status_by_family: dict[
        str, Any
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_action_by_family: dict[
        str, Any
    ] = {}
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_actions: list[
        str
    ] = []
    ...
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_network_call_policy = (
        None
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_mutates_local_state = (
        False
    )
    one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_secret_values_returned = (
        False
    )
    ...
    if one_shot_pipeline_smoke_blocked_reason == "api_key_setup_not_ready":
        ...
        one_shot_pipeline_smoke_unblock_source_path = (
            api_key_next_action_summary.get("source_path")
        )
        one_shot_pipeline_smoke_unblock_target_path = (
            api_key_next_action_summary.get("target_path")
        )
        one_shot_pipeline_smoke_unblock_dotenv_target_path = (
            api_key_next_action_summary.get("dotenv_target_path")
        )
        if one_shot_pipeline_smoke_unblock_next_after_action == (
            ...
            one_shot_pipeline_smoke_unblock_followup_smoke_required_env_keys_by_family = {
            ...
            one_shot_pipeline_smoke_unblock_followup_smoke_configured_provider_family_count = sum(
                1
                for configured in (
                    one_shot_pipeline_smoke_unblock_followup_smoke_configured_by_family.values()
                )
                if configured
            )
            one_shot_pipeline_smoke_unblock_followup_smoke_blocked_provider_family_count = (
                len(
                    one_shot_pipeline_smoke_unblock_followup_smoke_provider_families
                )
                - one_shot_pipeline_smoke_unblock_followup_smoke_configured_provider_family_count
            ...
            one_shot_pipeline_smoke_unblock_followup_smoke_setup_status_by_family = {
            ...
            one_shot_pipeline_smoke_unblock_followup_smoke_requires_api_keys = (
                bool(one_shot_pipeline_smoke_unblock_followup_required_env_keys)
                and one_shot_pipeline_smoke_unblock_followup_smoke_network_call
            )
            one_shot_pipeline_smoke_unblock_followup_smoke_ready_after_env_keys = (
                bool(one_shot_pipeline_smoke_unblock_followup_smoke_command)
                and bool(one_shot_pipeline_smoke_unblock_followup_required_env_keys)
            ...
            if one_shot_pipeline_smoke_unblock_followup_smoke_ready_after_env_keys:
            ...
            if (
                ...
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_status = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_status
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_requires_api_keys = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_requires_api_keys
                ...
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_family_count = len(
                    set(
                        one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_class_by_family
                    )
                    | set(
                ...
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_family_count = sum(
                    1
                    for selected_provider_class in one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_class_by_family.values()
                    if isinstance(selected_provider_class, str)
                    and bool(selected_provider_class)
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_live_data_required_family_count = sum(
                    1
                    for live_data_required in one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_live_data_required_by_family.values()
                    if live_data_required is True
                )
                for data_mode in one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_data_mode_by_family.values():
                    if isinstance(data_mode, str) and data_mode:
                        one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_data_mode_counts[
                            data_mode
                        ] = (
                            one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_data_mode_counts.get(
                                data_mode, 0
                            )
                            + 1
                        )
                ...
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_preferred_env_key_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_preferred_env_key_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_accepted_env_keys_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_accepted_env_keys_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_required_env_keys_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_required_env_keys_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_missing_env_keys_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_missing_env_keys
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_configured_env_keys_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_configured_env_keys
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_configured_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_configured_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_setup_status_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_setup_status_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_action_by_family = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_next_setup_action_by_family
                )
                one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_actions = (
                    one_shot_pipeline_smoke_unblock_followup_smoke_next_setup_actions
                )
    ...
    return {
        ...
        "api_key_integration_one_shot_pipeline_smoke_unblock_followup_required_env_key_count": (
            len(one_shot_pipeline_smoke_unblock_followup_required_env_keys)
        ),
