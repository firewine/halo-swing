...
def test_run_api_key_pipeline_smoke_summary_only_returns_compact_status_payload(
    ...
    assert (
        ...
        == payload["api_key_integration_selected_provider_classes"]
    )
    assert (
        payload[
        ...
        == len(payload["api_key_integration_selected_provider_classes"])
    )
    assert (
        payload[
        ...
        == payload["api_key_integration_selected_provider_class_by_family"]
    )
    assert (
        payload[
        ...
        == payload["api_key_integration_provider_route_data_mode_by_family"]
    )
    assert (
        payload[
...
def test_run_api_key_pipeline_smoke_summary_only_keeps_integration_status_summary(
    ...
    expected_one_shot_unblock_followup_smoke_provider_by_family: dict[str, object] = {}
    expected_one_shot_unblock_followup_smoke_preferred_env_key_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_accepted_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    expected_one_shot_unblock_followup_smoke_required_env_keys_by_family: dict[
        str, list[str]
    ] = {}
    ...
    expected_one_shot_unblock_followup_smoke_configured_provider_families: list[
        str
    ] = []
    expected_one_shot_unblock_followup_smoke_blocked_provider_families: list[str] = []
    ...
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_name = (
        None
    )
    ...
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_provider_families: list[
        str
    ] = []
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_provider_families: list[
        str
    ] = []
    ...
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_classes: list[
        str
    ] = []
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_class_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_provider_route_data_mode_by_family: dict[
        str, object
    ] = {}
    ...
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys: list[
        str
    ] = []
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys: list[
        str
    ] = []
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_setup_status_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_action_by_family: dict[
        str, object
    ] = {}
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_actions: list[
        str
    ] = []
    ...
    expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_secret_values_returned = False
    ...
    if expected_one_shot_unblock_next_after_action == "fill_live_data_api_keys":
        ...
        provider_requirement_rows = {
            family: provider_requirements.get(family, {})
        ...
        expected_one_shot_unblock_followup_smoke_accepted_env_keys_by_family = {
            family: row.get("accepted_env_keys", [])
            for family, row in provider_requirement_rows.items()
        }
        expected_one_shot_unblock_followup_smoke_required_env_keys_by_family = {
            family: row.get("required_env_keys", [])
            for family, row in provider_requirement_rows.items()
        }
        expected_one_shot_unblock_followup_smoke_missing_env_keys_by_family = {
            family: row.get("missing_env_keys", [])
            for family, row in provider_requirement_rows.items()
        }
        ...
        expected_one_shot_unblock_followup_smoke_configured_provider_families = [
            family
            for family in expected_one_shot_unblock_followup_smoke_provider_families
            if expected_one_shot_unblock_followup_smoke_configured_by_family.get(
                family
            )
            is True
        ]
        ...
        if (
            ...
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_provider_families = (
                expected_one_shot_unblock_followup_smoke_provider_families
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_provider_families = (
                expected_one_shot_unblock_followup_smoke_configured_provider_families
            )
            ...
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_selected_provider_classes = (
            ...
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys_by_family = (
                expected_one_shot_unblock_followup_smoke_missing_env_keys_by_family
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_missing_env_keys = (
                expected_one_shot_unblock_followup_smoke_missing_env_keys
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys_by_family = (
                expected_one_shot_unblock_followup_smoke_configured_env_keys_by_family
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_env_keys = (
                expected_one_shot_unblock_followup_smoke_configured_env_keys
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_configured_by_family = (
                expected_one_shot_unblock_followup_smoke_configured_by_family
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_setup_status_by_family = (
                expected_one_shot_unblock_followup_smoke_setup_status_by_family
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_action_by_family = (
                expected_one_shot_unblock_followup_smoke_next_setup_action_by_family
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_next_setup_actions = (
                expected_one_shot_unblock_followup_smoke_next_setup_actions
            )
            ...
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_network_call_policy = (
                expected_one_shot_unblock_followup_smoke_network_call_policy
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_mutates_local_state = (
                expected_one_shot_unblock_followup_smoke_mutates_local_state
            )
            expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_secret_values_returned = (
                expected_one_shot_unblock_followup_smoke_secret_values_returned
            )
    ...
    assert (
        ...
        is expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_network_call
    )
    assert (
        payload[
            "api_key_integration_one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_network_call_policy"
    ...
    assert (
        ...
        is expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_mutates_local_state
    )
    assert (
        payload[
            "api_key_integration_one_shot_pipeline_smoke_unblock_followup_smoke_api_key_only_setup_next_command_secret_values_returned"
        ]
        is expected_one_shot_unblock_followup_smoke_api_key_only_setup_next_command_secret_values_returned
    )
    assert (
        payload[
            "api_key_integration_one_shot_pipeline_smoke_unblock_followup_smoke_network_call"
...
def test_api_key_pipeline_summary_cli_reads_whitespace_wrapped_launch_directory_dotenv_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
...
def test_api_key_pipeline_summary_cli_reads_quoted_launch_directory_dotenv_values(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "POLYGON_API_KEY": "polygon-cli-quoted-secret",
        "FRED_API_KEY": "fred-cli-quoted-secret",
        "NEWS_API_KEY": "news-cli-quoted-secret",
    }
    (tmp_path / ".env.example").write_text(
        "POLYGON_API_KEY=\nFRED_API_KEY=\nNEWS_API_KEY=\n",
        encoding="utf-8",
    ...
    (tmp_path / ".env").write_text(
        "\n".join(
            [
                ...
                "HALO_SWING_TELEGRAM_GATEWAY_URL=",
                "HALO_SWING_LIVE_HTTP_TIMEOUT_SECONDS=0.001",
                f"POLYGON_API_KEY=\"{secret_env['POLYGON_API_KEY']}\" # polygon",
                f"FRED_API_KEY='{secret_env['FRED_API_KEY']}' # fred",
                f"NEWS_API_KEY=\"{secret_env['NEWS_API_KEY']}\" # newsapi",
            ]
        ),
        encoding="utf-8",
    )
...
def test_api_key_pipeline_summary_cli_rejects_launch_directory_dotenv_placeholders(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
...
def test_api_key_pipeline_summary_cli_rejects_launch_directory_dotenv_control_character_keys(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    malformed_env = {
        "POLYGON_API_KEY": "polygon-cli-dotenv-control\tsecret",
        "FRED_API_KEY": "fred-cli-dotenv-control\tsecret",
        "NEWS_API_KEY": "news-cli-dotenv-control\tsecret",
    }
    (tmp_path / ".env.example").write_text(
        "POLYGON_API_KEY=\nFRED_API_KEY=\nNEWS_API_KEY=\n",
        encoding="utf-8",
    ...
    dotenv_text = "\n".join(
        [
            ...
            "HALO_SWING_TELEGRAM_GATEWAY_URL=",
            "HALO_SWING_LIVE_HTTP_TIMEOUT_SECONDS=0.001",
            *(f"{key}={value}" for key, value in malformed_env.items()),
        ]
    )
    (tmp_path / ".env").write_text(dotenv_text, encoding="utf-8")
    ...
    assert payload["secret_values_returned"] is False
    assert (tmp_path / ".env").read_text(encoding="utf-8") == dotenv_text
    for value in malformed_env.values():
        assert value not in completed.stdout
        assert value.strip() not in completed.stdout
        assert value not in serialized
        assert value.strip() not in serialized
...
def test_api_key_pipeline_summary_cli_reads_whitespace_wrapped_project_alias_dotenv_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
...
def test_api_key_pipeline_summary_cli_rejects_launch_directory_project_alias_dotenv_control_character_keys(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    malformed_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-dotenv-control\tsecret",
        "HALO_SWING_MACRO_API_KEY": "macro-cli-dotenv-control\tsecret",
        "HALO_SWING_NEWS_API_KEY": "news-cli-dotenv-control\tsecret",
    }
    (tmp_path / ".env.example").write_text(
        (
            "HALO_SWING_MARKET_DATA_API_KEY=\n"
...
def test_api_key_pipeline_summary_cli_reads_dotenv_real_aliases_with_blank_siblings_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-dotenv-real-over-blank",
        "HALO_SWING_FRED_API_KEY": "fred-cli-dotenv-real-over-blank",
        "HALO_SWING_NEWS_API_KEY": "news-cli-dotenv-real-over-blank",
    }
    blank_env = {
        "POLYGON_API_KEY": "",
        "FRED_API_KEY": "",
    ...
    dotenv_text = "\n".join(
        [
            ...
            "HALO_SWING_TELEGRAM_GATEWAY_URL=",
            "HALO_SWING_LIVE_HTTP_TIMEOUT_SECONDS=0.001",
            *(f"{key}={value}" for key, value in blank_env.items()),
            *(f"{key}={value}" for key, value in secret_env.items()),
        ]
    )
    (tmp_path / ".env").write_text(dotenv_text, encoding="utf-8")
...
def test_api_key_pipeline_summary_cli_reads_duplicate_real_dotenv_aliases_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
...
def test_api_key_pipeline_summary_cli_reads_mixed_dotenv_env_aliases_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-mixed-dotenv-secret",
        "FRED_API_KEY": "fred-cli-mixed-dotenv-secret",
        "HALO_SWING_NEWS_API_KEY": "news-cli-mixed-dotenv-secret",
    }
    (tmp_path / ".env.example").write_text(
        (
            "HALO_SWING_MARKET_DATA_API_KEY=\n"
...
def test_api_key_pipeline_summary_cli_reads_dotenv_real_aliases_with_exported_placeholder_siblings_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-dotenv-real-exported-placeholder",
        "HALO_SWING_FRED_API_KEY": "fred-cli-dotenv-real-exported-placeholder",
        "HALO_SWING_NEWS_API_KEY": "news-cli-dotenv-real-exported-placeholder",
    }
    placeholder_env = {
        "POLYGON_API_KEY": "your_polygon_key",
        "FRED_API_KEY": "your_fred_key",
    ...
    for key in READINESS_ENV_KEYS:
        env.pop(key, None)
    env.update({"PYTHONPATH": str(ROOT / "src"), **placeholder_env})
    for key in secret_env:
        assert key not in env
...
def test_api_key_pipeline_summary_cli_reads_dotenv_real_aliases_with_exported_blank_siblings_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-dotenv-real-exported-blank",
        "HALO_SWING_FRED_API_KEY": "fred-cli-dotenv-real-exported-blank",
        "HALO_SWING_NEWS_API_KEY": "news-cli-dotenv-real-exported-blank",
    }
    blank_env = {
        "POLYGON_API_KEY": "",
        "FRED_API_KEY": "",
    ...
    for key in READINESS_ENV_KEYS:
        env.pop(key, None)
    env.update({"PYTHONPATH": str(ROOT / "src"), **blank_env})
    for key in secret_env:
        assert key not in env
...
def test_api_key_pipeline_summary_cli_reads_dotenv_preferred_keys_with_exported_alias_malformed_values_without_secret_output(
    ...
    malformed_env = {
        ...
        "HALO_SWING_MACRO_API_KEY": "macro-exported-alias-control\nsecret",
        "HALO_SWING_NEWS_API_KEY": "news-exported-alias-control\rsecret",
    }
    (tmp_path / ".env.example").write_text(
        (
            "POLYGON_API_KEY=\n"
    ...
    for key in READINESS_ENV_KEYS:
        env.pop(key, None)
    env.update({"PYTHONPATH": str(ROOT / "src"), **malformed_env})
    for key in secret_env:
        assert key not in env
...
def test_api_key_pipeline_summary_cli_respects_exported_disable_dotenv_with_launch_directory_dotenv_secrets(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "POLYGON_API_KEY": "polygon-cli-disabled-dotenv-secret",
        "FRED_API_KEY": "fred-cli-disabled-dotenv-secret",
        "NEWS_API_KEY": "news-cli-disabled-dotenv-secret",
    }
    (tmp_path / ".env.example").write_text(
        "POLYGON_API_KEY=\nFRED_API_KEY=\nNEWS_API_KEY=\n",
        encoding="utf-8",
...
def test_api_key_pipeline_summary_cli_reads_exported_project_alias_env_without_dotenv_secrets(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-exported-alias-secret",
        "HALO_SWING_MACRO_API_KEY": "macro-cli-exported-alias-secret",
        "HALO_SWING_NEWS_API_KEY": "news-cli-exported-alias-secret",
    }
    (tmp_path / ".env.example").write_text(
        (
            "HALO_SWING_MARKET_DATA_API_KEY=\n"
...
def test_api_key_pipeline_summary_cli_reads_whitespace_wrapped_exported_project_aliases_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
...
def test_api_key_pipeline_summary_cli_rejects_exported_project_alias_control_character_keys_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    malformed_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-exported-alias-control\n",
        "HALO_SWING_MACRO_API_KEY": "macro-cli-exported-alias-control\r",
        "HALO_SWING_NEWS_API_KEY": "news-cli-exported-alias-control\t",
    }
    (tmp_path / ".env.example").write_text(
        (
            "HALO_SWING_MARKET_DATA_API_KEY=\n"
...
def test_api_key_pipeline_summary_cli_reads_mixed_exported_env_aliases_without_dotenv_secrets(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-mixed-exported-secret",
        "FRED_API_KEY": "fred-cli-mixed-exported-secret",
        "HALO_SWING_NEWS_API_KEY": "news-cli-mixed-exported-secret",
    }
    (tmp_path / ".env.example").write_text(
        (
            "HALO_SWING_MARKET_DATA_API_KEY=\n"
...
def test_api_key_pipeline_summary_cli_reads_real_exported_aliases_with_placeholder_siblings(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-real-over-placeholder-secret",
        "HALO_SWING_FRED_API_KEY": "fred-cli-real-over-placeholder-secret",
        "HALO_SWING_NEWS_API_KEY": "news-cli-real-over-placeholder-secret",
    }
    placeholder_env = {
        "POLYGON_API_KEY": "your_polygon_key",
        "FRED_API_KEY": "your_fred_key",
...
def test_api_key_pipeline_summary_cli_reads_real_exported_aliases_with_blank_siblings(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "HALO_SWING_MARKET_DATA_API_KEY": "market-cli-real-over-blank-secret",
        "HALO_SWING_FRED_API_KEY": "fred-cli-real-over-blank-secret",
        "HALO_SWING_NEWS_API_KEY": "news-cli-real-over-blank-secret",
    }
    blank_env = {
        "POLYGON_API_KEY": "",
        "FRED_API_KEY": "",
...
def test_api_key_pipeline_summary_cli_reads_duplicate_real_exported_aliases_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
...
def test_api_key_pipeline_summary_cli_reads_whitespace_wrapped_exported_keys_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "POLYGON_API_KEY": "  polygon-cli-whitespace-secret  ",
        "FRED_API_KEY": " fred-cli-whitespace-secret ",
        "NEWS_API_KEY": " news-cli-whitespace-secret ",
    }
    (tmp_path / ".env.example").write_text(
        "POLYGON_API_KEY=\nFRED_API_KEY=\nNEWS_API_KEY=\n",
        encoding="utf-8",
...
def test_api_key_pipeline_summary_cli_reads_newsapi_key_alias_without_secret_output(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
    secret_env = {
        "POLYGON_API_KEY": "polygon-cli-newsapi-alias-secret",
        "FRED_API_KEY": "fred-cli-newsapi-alias-secret",
        "NEWSAPI_KEY": "newsapi-cli-alias-secret",
    }
    (tmp_path / ".env.example").write_text(
        "POLYGON_API_KEY=\nFRED_API_KEY=\nNEWSAPI_KEY=\n",
        encoding="utf-8",
...
def test_api_key_pipeline_summary_cli_rejects_control_character_exported_keys_without_secret_output(
    ...
    clear_readiness_env(monkeypatch)
    malformed_env = {
        "POLYGON_API_KEY": "polygon-cli-control-secret\n",
        "FRED_API_KEY": "fred-cli-control-secret\r",
        "NEWS_API_KEY": "news-cli-control-secret\t",
    }
    (tmp_path / ".env.example").write_text(
        "POLYGON_API_KEY=\nFRED_API_KEY=\nNEWS_API_KEY=\n",
        encoding="utf-8",
...
def test_api_key_pipeline_summary_cli_rejects_exported_placeholder_values(
    tmp_path: Path,
    monkeypatch,
) -> None:
    clear_readiness_env(monkeypatch)
