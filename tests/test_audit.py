...
def test_audit_web_events_endpoint_returns_bad_request_for_invalid_audit_log_path(
    tmp_path: Path,
) -> None:
...
def test_audit_web_events_endpoint_returns_bad_request_for_invalid_env_audit_path(
    tmp_path: Path,
    monkeypatch,
) -> None:
    monkeypatch.chdir(tmp_path)
