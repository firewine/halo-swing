...
objective: extend SQLite filtered latest report coverage proving selected sqlite name-free surface order after repository selection
...
done_when:
  - SQLite repository-backed latest report timeframe selected sqlite name-free surface order is verified after repository selection
  - SQLite repository-backed latest report underlying selected sqlite name-free surface order is verified after repository selection
  - selected sqlite name-free coverage preserves sqlite name-free surface order after repository selection
...
results:
  ...
  - full pytest passed: 935 passed in 45.37s
  - ruff passed
