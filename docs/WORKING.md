...
objective: extend SQLite filtered latest report coverage proving path-component-free surface order after repository selection
...
done_when:
  - SQLite repository-backed latest report timeframe path-component-free surface order is verified after repository selection
  - SQLite repository-backed latest report underlying path-component-free surface order is verified after repository selection
  - path-component-free coverage preserves filtered report surface order after repository selection
...
results:
  ...
  - full pytest passed: 935 passed in 41.98s
  - ruff passed
