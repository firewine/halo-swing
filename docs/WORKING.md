...
objective: extend SQLite filtered latest report coverage proving excluded-record-free surface order after repository selection
...
done_when:
  - SQLite repository-backed latest report timeframe excluded-record-free surface order is verified after repository selection
  - SQLite repository-backed latest report underlying excluded-record-free surface order is verified after repository selection
  - excluded-record-free coverage preserves filtered report surface order after repository selection
...
results:
  ...
  - full pytest passed: 935 passed in 40.62s
  - ruff passed
