...
objective: extend SQLite filtered latest report coverage proving selected storage marker-free surface order after repository selection
...
done_when:
  - SQLite repository-backed latest report timeframe selected storage marker-free surface order is verified after repository selection
  - SQLite repository-backed latest report underlying selected storage marker-free surface order is verified after repository selection
  - selected storage marker-free coverage preserves storage marker-free surface order after repository selection
...
results:
  ...
  - full pytest passed: 935 passed in 56.86s
  - ruff passed
